    ...
    <div class={style.grid}>
      <div class={style.card}>
        ...
        <p class={style.cardDescription}>
          <span class={style.bold}>Client</span>: small business in thermal and
          sanitary installations
          <br />
          <span class={style.bold}>Current purpose</span>: scrape products from
          an external source that have been given in an Excel file
          <br />
          <span class={style.bold}>Objectives</span>:
          <ol>
            <li>gather missing data - products' current prices and images.</li>
            <li>
              download the products' images and upload on own host to be further
      ...
      <div class={style.card}>
        ...
        <p class={style.cardDescription}>
          Small, intuitive react app to convert binary numbers into decimal
